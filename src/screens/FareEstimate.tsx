...
const FareEstimate = () => {
  ...
  const { vehicle, pickup, drop, pickupCoords, dropCoords } =
    route.params || {};
        ...
        {loading ? (
          ...
          <View style={styles.errorContainer}>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                if (error.includes('select locations from suggestions')) {
                  navigation.goBack();
                } else {
                  fetchFareEstimate();
                }
            ...
            >
              <Icon
                name={
                  error.includes('select locations from suggestions')
                    ? 'arrow-back'
                    : 'refresh'
                }
                size={20}
          ...
          <>
            ...
            <View style={styles.card}>
              ...
              <View style={styles.fareRow}>
                ...
                <Text style={styles.fareValue}>
                  ₹{fareData?.distance_charge || 0}
                </Text>
              </View>
              <View style={styles.fareRow}>
                <Text style={styles.fareLabel}>Platform Charge</Text>
                <Text style={styles.fareValue}>
                  ₹{fareData?.platform_charge || 0}
                </Text>
              </View>
              <View style={styles.fareRow}>
                <Text style={styles.fareLabel}>GST (5%)</Text>
                <Text style={styles.fareValue}>₹{fareData?.gst || 0}</Text>
              </View>
              ...
              >
                <View style={styles.paymentIconContainer}>
                  <Icon
                    name="money"
                    size={28}
                    color={selectedPayment === 'cash' ? '#8B5CF6' : '#6B7280'}
                  />
                </View>
              ...
              >
                <View style={styles.paymentIconContainer}>
                  <Icon
                    name="credit-card"
                    size={28}
                    color={selectedPayment === 'online' ? '#8B5CF6' : '#6B7280'}
                  />
                </View>
                <View style={styles.paymentInfo}>
                  <Text
